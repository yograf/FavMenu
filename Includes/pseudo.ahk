FavMenu_ConvertPseudoPath(ppath)
{

	StringGetPos idxS, ppath, `%$
	StringGetPos idxE, ppath, `%, , idxS + 2

	StringMid pvar, ppath, idxS+3, idxE-idxS-2
	StringReplace out, ppath, `%$%pvar%`%, % FavMenu_GetCommonPath(pvar)
